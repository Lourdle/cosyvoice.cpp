...
static void print_usage(const tchar* argv0)
{
	...
	printf("  CLI defaults: speed=1.0, max-llm-len=2048, llm-kv-cache-type=q8_0, mode=auto.\n");
...
int main(int argc, char** argv)
{
	...
	print_tts_runtime_info(options, effective_params, generation_config, sample_rate, log_level);
